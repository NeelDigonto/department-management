        ...
        csv_data.forEach((row, index) => {
          ...
          const sanitizeData = () => {
            ...
            if (first_delimiter === -1) {
              ...
              speaker_name = row["speaker_details"].substring(0, first_delimiter);
              speaker_designation = "";
              speaker_org = row["speaker_details"].substring(first_delimiter + 1);
              ...
              speaker_org = row["speaker_details"].substring(last_delimiter + 1);
              if (speaker_org[0] === " ") speaker_org = speaker_org.substring(1);
            }
          ...
          if (
            collectionData.find((user) => user.employeeID === row["faculty_name"]) === undefined
          ) {
            collectionData.push({
