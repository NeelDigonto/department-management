...
const ADDRESS_VALIDATION_SCHEMA = Yup.string()
  .min(5, "Too Short!")
  .max(100, "Too Long!")
  .required("Required!");
...
const MOBILE_VALIDATION_SCHEMA = Yup.string()
  .length(10, "Must be of 10 digits!")
  .required("Required!");

const LANDLINE_VALIDATION_SCHEMA = Yup.string()
  .length(8, "Must be of 10 digits!")
  .required("Required!");

const DATE_VALIDATION_SCHEMA = Yup.date().required("Required!");

const TITLE_VALIDATION_SCHEMA = Yup.string()
  .min(2, "Too Short!")
  .max(200, "Too Long!")
  .required("Required!");
